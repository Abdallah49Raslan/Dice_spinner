...
import 'package:dice/features/liars_dice/Pages/setup_page/cubit/setup_cubit.dart';
...
class LiarsDiceSetupPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (_) =>
          LiarsDiceSetupCubit(LiarsDiceHistoryStorage())
            ..init(initialCount: 2, defaultName: defaultName),
      child: Scaffold(
